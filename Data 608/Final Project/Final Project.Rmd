...
```{r engine='python', highlight=TRUE, eval = FALSE, echo = FALSE}
import pandas as pd
...
trace4 = go.Bar(x=region, y=robots, name = 'Wholesale trade')
trace5 = go.Bar(x=region, y= meat, name = 'Retail trade' )
...
plot(fig, filename='employ.html')
```

```{r fig.width=8, echo=FALSE}
htmltools::includeHTML("https://raw.githubusercontent.com/ChristopheHunt/MSDA---Coursework/master/Data%20608/Final%20Project/employ.html")
```
...
fig = Figure(data=data, layout=layout)
py.plot(fig, filename='tech views.html')
```
