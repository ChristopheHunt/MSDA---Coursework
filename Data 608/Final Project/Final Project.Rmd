...
columns <- read.csv("https://raw.githubusercontent.com/ChristopheHunt/MSDA---Coursework/master/Data%20608/Final%20Project/columns%20to%20use%20from%20employment%20data.csv", header = TRUE)

employData <- employData %>%
              filter(Variable %in% as.vector(columns$ï..column))
```
