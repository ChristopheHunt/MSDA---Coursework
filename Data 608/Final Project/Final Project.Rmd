...
It would seem that perhaps we will see regional differences in views of certain technologies and the employment types. For instance, in the census region `South` nearly every state has the greatest occupation as Truck Driver except for Florida which has Primary School Teacher. Let's see the percentage of positive views for this question by region. 
...
ggplot(region.df.drvlesscar) + 
  ...
  theme_void() +
  scale_fill_gradientn(colors = rev(brewer.pal(9,"PuBu")), space = "Lab", guide = "legend") +
