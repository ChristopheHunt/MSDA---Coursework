...
```{r engine='python', highlight=TRUE,echo = FALSE, eval = TRUE, cache=TRUE}
from plotly import __version__
from plotly.offline import init_notebook_mode, plot, iplot
from plotly.graph_objs import *
import plotly.plotly as py
import pandas as pd 
py.sign_in('Blastophe', 'hkV1iJvT8aPiuNi0Va4g')
...
plot(fig, filename='tech views.html')
```

```{r fig.width=8, echo=FALSE,  cache=TRUE, fig.width=6, fig.height=3}
...
```{r fig.width=8, echo=FALSE, cache=TRUE, fig.height=450}
