...
A national survey was conducted by Pew Research Center in conjunction with Smithsonian magazine between February 13-18, 2014 by landline and cell phones among 1,001 adults. The objective of the survey was to better understand US views towards scientific and technological changes occuring during this time period.  
...
However, if we look at a map of a recent analysis by [NPR's Planet Money](http://www.npr.org/sections/money/2015/02/05/382664837/map-the-most-common-job-in-every-state) <a href="#footnote-1">[1]</a> we see that the most common job in most states is truck driver. This type of employement may be made obsolete as more and more individuals being comfortable with driver-less vehicles.  
