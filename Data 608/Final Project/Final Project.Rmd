...
survey.data$pial4b <- gsub("\\()", "", gsub("(VOL.)", "", gsub("â???T", "'", survey.data$pial4b)))
...
It would seem that perhaps we will regional differences in views of certain technologies and the employment types. For instance, in the census region `South` nearly every state has the greatest occupation as Truck Driver except for Florida which has Primary School Teacher has the greatest occupation. 
