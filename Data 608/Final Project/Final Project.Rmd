...
```{r, results='asis', echo=FALSE, message=FALSE, warning = FALSE, error=FALSE, eval=FALSE}
library(plotly)
  ...
  layout(
    ...
    updatemenus = list(
      list(
        ...
        buttons = list(
          list(method = "restyle",
               args = list("visible", list(TRUE, FALSE, FALSE, FALSE, FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)),
               label = "Agriculture, forestry, <br>fishing and hunting, and mining"),
          list(method = "restyle",
               args = list("visible", list(FALSE, FALSE, FALSE, FALSE, FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)),
               label = "Construction"),
          list(method = "restyle",
               args = list("visible", list(FALSE, FALSE, FALSE, FALSE, FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)),
               label = "Manufacturing"),
...
```{r fig.width=8}
htmltools::includeHTML("https://raw.githubusercontent.com/ChristopheHunt/MSDA---Coursework/master/Data%20608/Final%20Project/tech%20views.html")
```
