...
The reason that `attempt_1` fails is because the carat `^` symbol inverses the matching. So it is looking for anything but 0-9. Also the period `.` is any characters after the matching of one time using the `+` symbol. 
