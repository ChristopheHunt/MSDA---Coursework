...
As aspiring **Data Scientists** a very common question is *what skills are important in today's market place?*, Data Science has reputation for rapidly changing and so do the tools. Since we want to be as well trained as  possible at the completion of the CUNY MSDA program we set out to answer "Which skills are the most valued data science skills?". 
...
3. Data visualization and analysis - *"Presenters"*
      - Antonio, Christophe, Musa, Daniel, Valerie, Yadu, Dan B.
      
## Team Communication {.smaller}

The communications strategy consisted of *all-hands on deck* team meetings on the first Monday of the week using Webex. 

We further communicated through emails, texts, phone calls and small sub group meetings throughout the weeks as necessary. 
...
Data was shared using combination of github and rpubs. The database is available @ using the following code: 
