...
kable(t(head(chess.data))) #check formats
```

Now we have the dataframe in an appropriate format to use find the mean of the opponents played in the chess tournament. 
