...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 5.7/Uploads/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
