...
\subsection{Checked Mathematically}\label{checked-mathematically}
...
of each other. The below venn diagram from Wikipedia may provide a
clearer understanding of the differences in these measures.
\end{quote}

\includegraphics{https://raw.githubusercontent.com/ChristopheHunt/MSDA---Coursework/master/Data\%20605/Final\%20Project/Entropy-mutual-information-relative-entropy-relation-diagram.PNG\%20\%7C250x250}
By KonradVoelkel (Own work) {[}Public domain{]}, via Wikimedia Commons
...
\begin{quote}
The histogram shows a right skewed distribution, which is not
unexpected, as we see houses with similar lot areas in cities with fewer
houses having large lot areas.
\end{quote}
...
\subsection{\texorpdfstring{\protect\includegraphics{Final_Project_files/figure-latex/unnamed-chunk-14-1.pdf}
