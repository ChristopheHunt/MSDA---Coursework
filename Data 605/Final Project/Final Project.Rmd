...
> We see that the p-value is quite low, lower than the assumptive .05, so we therefore reject the null hypothesis that the values are independent of each other. The below venn diagram from Wikipedia may provide a clearer understanding of the differences in these measures.

![](https://raw.githubusercontent.com/ChristopheHunt/MSDA---Coursework/master/Data%20605/Final%20Project/Entropy-mutual-information-relative-entropy-relation-diagram.PNG |250x250) By KonradVoelkel (Own work) [Public domain], via Wikimedia Commons   
...
> The histogram shows a right skewed distribution, which is not unexpected, as we see houses with similar lot areas in cities with fewer houses having large lot areas. 
