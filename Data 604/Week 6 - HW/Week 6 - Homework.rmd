...
> An object property is defined within an object to collect information from the user to customize that object's behavior. Whereas an object state is defined within an object and holds the value of something that might change while a model is running.   
