...
\StringTok{  A [label = 'C1, R1 }\CharTok{\textbackslash{}n}\StringTok{ (1/2)']; }
\StringTok{  B [label = 'C1, R2 }\CharTok{\textbackslash{}n}\StringTok{ (1)']; }
\StringTok{  C [label = 'C2, R1 }\CharTok{\textbackslash{}n}\StringTok{ (1/2)']; }
\StringTok{  D [label = 'C2, R2 }\CharTok{\textbackslash{}n}\StringTok{ (0)']; }

\StringTok{  # several 'edge' statements}
\StringTok{  D->B D->C A->B A->C C->A}
\StringTok{\}}
\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
