...
> $E(Lease) = 1 * 100000$  
> $E(Keep) = .4 * 280000 + .2 * 100000 + .4 * -40000 = `r (.4 * 280000) + (.2 * 100000) + (.4 * -40000)`$
...
\small{E(hire geoglist) = (.6 * .85 * 4900000) + (.6 * .15 * -1100000) + (.4 * .22 * 4900000) + (.4 * .78 * -1100000) = \`r dollar((.6 * .85 * 4900000) + (.6 * .15 * -1100000) + (.4 * .22 * 4900000) + (.4 * .78 * -1100000))`}
