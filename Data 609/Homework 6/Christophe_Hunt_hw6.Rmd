...
plotFun(((-8/6)*x) + (48/6) ~ x, xlim = c(0, 20), ylim = c(0,30), ylab = "")
```

```{r, fig.height=3}
plotFun((-4*x)+ 20 ~ x, xlim = c(0, 20), ylim = c(0,30), col = c("red"), add = TRUE, under = TRUE,  ylab = "")
```

```{r, fig.height=3}
plotFun(0*x+5 ~ x, xlim = c(0, 20), ylim = c(0,30), col = c("green"), add = TRUE, under = TRUE,  ylab = "")
```
