...
The data does not support the proportion model because the y-intercept is not 0. Since we have a value (0,1) we can determine that the line does not pass through the origin of (0,0). Therefore this data will not support a proportional model. 
