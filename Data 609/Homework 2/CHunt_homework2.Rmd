...
The data does not support the proportion model. Our used model for this data is $y = 38.5x^3$ where $k = 38.5$. This is achieved by taking $y = x^3$ and substituting x for the values in our provided data set. Then we obtain the ratio of $y/x^3$ and further obtain the mean which is $38.5$. As illustrated above the model does not follow. 
