...
The data does not support the proportion modelsince our data does not pass through the origin (0,0) and our slope is small comparitive to 1. Our used model for this data is $y = .426x^3$ where $k = .426$. This is achieved by taking $y^\frac{1}{3}$ and from the values in our provided data set. Then we obtain the ratio of $\frac{y^\frac{1}{3}}{x}$ and further obtain the mean which is $.426$. As illustrated above the model illustrates that the data does not follow the proportional model. 
