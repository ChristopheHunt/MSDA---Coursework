...
The first model for $y \propto x^2$ because it more closely follows the shape of the observed data. This is likely due to tree growth being stable and that heights are similar among trees with similar diameters. 
