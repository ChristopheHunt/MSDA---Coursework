...
\NormalTok{unfair_roll <-}\StringTok{ }\NormalTok{function(n, probs)\{}
    ...
    \NormalTok{for (i in }\DecValTok{1}\NormalTok{:n)\{}
        \NormalTok{x <-}\StringTok{ }\KeywordTok{runif}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
      \NormalTok{if (x >=}\StringTok{ }\DecValTok{0} \NormalTok{&}\StringTok{ }\NormalTok{x <=}\StringTok{ }\NormalTok{probs[[}\DecValTok{1}\NormalTok{]])\{}
        \NormalTok{results$}\StringTok{`}\DataTypeTok{1}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{1}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1} 
       \NormalTok{\} else if (x >}\StringTok{ }\NormalTok{probs[[}\DecValTok{1}\NormalTok{]] &}\StringTok{ }
\StringTok{                  }\NormalTok{x <=}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]))\{}
        \NormalTok{results$}\StringTok{`}\DataTypeTok{2}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{2}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1} 
       \NormalTok{\} else if (x >}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]) &}\StringTok{ }
\StringTok{                  }\NormalTok{x <=}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{3}\NormalTok{]], probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]))\{ }
        \NormalTok{results$}\StringTok{`}\DataTypeTok{3}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{3}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1}
       \NormalTok{\} else if (x >}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{3}\NormalTok{]], probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]) &}\StringTok{ }
\StringTok{                  }\NormalTok{x <=}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{4}\NormalTok{]],probs[[}\DecValTok{3}\NormalTok{]], probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]))\{}
        \NormalTok{results$}\StringTok{`}\DataTypeTok{4}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{4}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1}
       \NormalTok{\} else if (x >}\StringTok{ }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{4}\NormalTok{]],probs[[}\DecValTok{3}\NormalTok{]], probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]) &}\StringTok{ }\NormalTok{x <=}\StringTok{ }
\StringTok{                  }\KeywordTok{sum}\NormalTok{(probs[[}\DecValTok{5}\NormalTok{]],probs[[}\DecValTok{4}\NormalTok{]],probs[[}\DecValTok{3}\NormalTok{]], probs[[}\DecValTok{2}\NormalTok{]], probs[[}\DecValTok{1}\NormalTok{]]))\{}
        \NormalTok{results$}\StringTok{`}\DataTypeTok{5}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{5}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1}
       \NormalTok{\} else \{ }
        \NormalTok{results$}\StringTok{`}\DataTypeTok{6}\StringTok{`} \NormalTok{<-}\StringTok{ }\NormalTok{results$}\StringTok{`}\DataTypeTok{6}\StringTok{`} \NormalTok{+}\StringTok{ }\DecValTok{1}
       \NormalTok{\}}
    \NormalTok{\}}
