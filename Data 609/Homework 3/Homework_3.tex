...
\StringTok{  }\KeywordTok{geom_abline}\NormalTok{(}\DataTypeTok{intercept =} \NormalTok{-}\DecValTok{20}\NormalTok{, }\DataTypeTok{slope =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
estimate of \textasciitilde{}4 for \(e\) if provided with an intercept
of -20. This is simply a best guess.
\end{quote}
