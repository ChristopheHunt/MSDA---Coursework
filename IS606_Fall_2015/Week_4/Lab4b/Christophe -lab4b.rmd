...
> I would expect that 100% of the intervals would capture the true population mean. I assume this because the sampling should be capturing the population mean, it would be unusual to capture a mean that would be more than the standard error multipled by 2 standard deviations away from the true population mean. 
